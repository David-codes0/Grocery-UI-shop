                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Container(
                          margin: const EdgeInsets.only(right: spacing_standard_new, top: spacing_middle),
                          decoration: const BoxDecoration(shape: BoxShape.circle, color: grocery_color_red),
                          padding: EdgeInsets.all(width * 0.02),
                          child: const Icon(Icons.delete, color: grocery_color_white),
                        ),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                margin: const EdgeInsets.only(right: spacing_standard_new, top: spacing_middle),
                decoration: const BoxDecoration(shape: BoxShape.circle, color: grocery_colorPrimary),
                padding: EdgeInsets.all(width * 0.02),
                child: const Icon(Icons.shopping_cart, color: grocery_color_white),
              ),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          icon: const Icon(Icons.delete_outline, color: grocery_icon_color),
                          onPressed: () {
                            mRemoveItem();
                          },
                        )
