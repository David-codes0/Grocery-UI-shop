              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text("David", style: boldTextStyle()),
                      2.height,
                      Text("davidadebayo@gmail.com", style: secondaryTextStyle()),
                      2.height,
                      Text("09039072131", style: secondaryTextStyle()),
                    ],
                  )
                ],
              ),
                  ...
                  Row(
                    children: [
                      Container(
                        height: 45,
                        width: 45,
                        decoration: boxDecoration(radius: 25.0, bgColor:grocery_DarkBlue_Color ),
                        child: Image.asset('images/ic_theme.png', height: 24, width: 24, color: grocery_color_white).paddingAll(12),
